...
class IndexController extends Controller
{
    public function index()
    {
        ...
        // dd($featuredProducts);
        $meta_title = "I-Code Multi Commerce";
        $meta_description = "Online shopping website deals in Clothings, Electronics & Appliances Products";
        $meta_keywords = 'eshop website, online shopping, multi vendor ecommerce';

        return view('front.index', compact('sliderBanners', 'fixBanners', 'newProducts', 'bestSellers', 'discountedProducts', 'featuredProducts', 'meta_title', 'meta_description', 'meta_keywords'));
    }
}
